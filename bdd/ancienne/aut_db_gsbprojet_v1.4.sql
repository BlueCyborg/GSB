...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : mar. 11 oct. 2022 à 09:25
...
(-1, 'Aucun', 'Aucun', NULL, NULL, NULL, NULL, 'PO', 0),
...
ALTER TABLE `presenter`
  ...
  ADD CONSTRAINT `fk_PRESENTER_to_RAPPORT_COLLABO` FOREIGN KEY (`COL_MATRICULE`,`RAP_NUM`) REFERENCES `rapport_visite` (`COL_MATRICULE`, `RAP_NUM`);
...
ALTER TABLE `travailler`
  ...
  ADD CONSTRAINT `fk_TRAVAILLER_to_VISITEUR` FOREIGN KEY (`COL_MATRICULE`) REFERENCES `collaborateur` (`COL_MATRICULE`);
COMMIT;
