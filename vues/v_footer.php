                    ...
                    <ul class="list-unstyled text-light light-300">
                        ...
                        ?>
                            ...
                            <?php if ($_SESSION['habilitation'] >= 2) { ?>
                                <li class="pb-2">
                                    <i class="bx-fw bx bxs-chevron-right bx-xs"></i><a class="text-decoration-none text-light py-1" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" href="index.php?uc=medecin&action=formulaireMedecin">Gérer médecin</a>
                                    <ul class="dropdown-menu dropdown-menu-dark p-0">
                                        <li><a class="dropdown-item" href="index.php?uc=medecin&action=formulaireMedecin">Choisir un médecin</a></li>
                                        <li><a class="dropdown-item" href="index.php?uc=medecin&action=creerMedecin">Créer un médecin</a></li>
                                    </ul>
                                </li>
                            <?php } ?>
