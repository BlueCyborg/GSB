<section class="bg-light">
    <div class="container">
        ...
        <div class="py-lg-5 py-3">
            <form action="index.php?uc=rapport&action=saisit" method="post" class="formulaire-recherche col-12 m-0 d-flex justify-content-between align-content-star p-3">
